...
import { OriginBarChart } from "./OriginRadialChart";
import { SectorsRadialChart } from "./SectorRadialChart";
import { CheckinPerHourChart } from "./CheckinPerHourChat";
    ...
    <div className="w-full space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <CardRoot
          ...
          className="lg:col-span-8 col-span-1 min-h-[480px] glass-card border-white/5 shadow-2xl rounded-[32px]"
        >
        ...
        <CardRoot
          ...
          className="lg:col-span-4 col-span-1 min-h-[480px] glass-card border-white/5 shadow-2xl rounded-[32px]"
        >
        ...
        <CardRoot
          ...
          className="lg:col-span-6 col-span-1 min-h-[420px] glass-card border-white/5 shadow-2xl rounded-[32px]"
        >
        ...
        <CardRoot
          ...
          className="lg:col-span-12 col-span-1 min-h-[480px] glass-card border-white/5 shadow-2xl rounded-[32px]"
        >
