...
export function MobilePartnerView({
  ...
  fairId,
  isAdminView = false,
}: MobilePartnerViewProps) {
  const [activeTab, setActiveTab] = useState<
    "overview" | "insights" | "withdrawals"
  >("overview");
      ...
      <div className="sticky top-0 z-10 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 p-4">
        <div className="text-center">
          <h1 className="text-xl font-bold text-gray-900 dark:text-white mb-1">
            {isAdminView
              ? `Sócio: ${partner.partnerName}`
              : `Olá, ${partner.partnerName}!`}
          </h1>
              ...
              <div className="space-y-3">
                <div className="p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                  ...
                  <p className="text-sm text-blue-600 dark:text-blue-400">
                    Recomendado para fluxo regular
                  </p>
                </div>
                ...
                <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                  ...
                  <p className="text-sm text-green-600 dark:text-green-400">
                    Para sócios com maior participação
                  </p>
                </div>
              </div>
            </Card>
