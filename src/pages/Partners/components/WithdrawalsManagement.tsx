...
export const WithdrawalsManagement: React.FC = () => {
  ...
  // Removido usePartnerByUserId - hook não existe
    ...
    return (
      <Card>
        <CardContent className="p-6">
          <p className="text-red-500">Erro: Nenhuma feira encontrada</p>
        </CardContent>
      </Card>
    );
  }
  ...
  const filteredWithdrawals = withdrawals?.filter((withdrawal: PartnerWithdrawal) => {
    const matchesSearch = 
      ...
      withdrawal.partnerId.toLowerCase().includes(searchTerm.toLowerCase());
  ...
  if (error) {
    return (
      <Card>
        <CardContent className="p-6">
          <p className="text-red-500">Erro ao carregar saques</p>
        </CardContent>
      </Card>
    );
  }
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input
                  placeholder="Buscar por sócio, motivo ou dados bancários..."
                  value={searchTerm}
            ...
            <div className="w-full sm:w-48">
              <Select value={selectedFairId} onValueChange={setFairFilter}>
                <SelectTrigger>
                    ...
                    <TableRow key={withdrawal.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex items-center gap-2 justify-end">
                              ...
                              {selectedWithdrawal && (
                                <div className="space-y-4">
                                  <div className="grid grid-cols-2 gap-4">
                                    <div>
                                      <label className="text-sm font-medium text-gray-500">Sócio</label>
                                      <p className="text-lg font-semibold">{selectedWithdrawal.partnerId}</p>
                                    </div>
                                    <div>
                                  ...
                                  {selectedWithdrawal.status === 'PENDING' && (
                                    <div className="pt-4 border-t space-y-4">
                                      <div>
                                        <Label htmlFor="rejection-reason">Motivo da Rejeição (se aplicável)</Label>
                                        <Textarea
                                          id="rejection-reason"
                          ...
                          {/* Ações rápidas para saques pendentes */}
                            ...
                            <div className="flex gap-1">
                              ...
                              <Dialog>
                                ...
                                <DialogContent>
                                  ...
                                  <div className="space-y-4">
                                    <div>
                                      <Label htmlFor="rejection-reason-modal">Motivo da Rejeição</Label>
                                      <Textarea
