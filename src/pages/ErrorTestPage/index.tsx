...
export const ErrorTestPage: React.FC = () => {
  ...
  const throwNetworkError = () => {
    // Simula erro de rede
    fetch("https://api-inexistente-12345.com/dados")
      .catch((error) => {
        ...
        <Card className="p-8 mb-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 mb-6">
              Esta página permite testar diferentes tipos de erros para verificar 
              se a página de erro personalizada está funcionando corretamente.
            </p>
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
              <div className="flex items-center">
                ...
                <p className="text-yellow-800 text-sm">
                  <strong>Atenção:</strong> Os botões abaixo irão causar erros reais na aplicação 
                  para testar o sistema de tratamento de erros.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card className="p-6">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Dispara um erro dentro de um componente React que será 
                capturado pelo Error Boundary.
              </p>
              <Button 
            ...
            <Card className="p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-3 font-semibold text-gray-900">Erro JavaScript</h3>
              </div>
              <p className="text-gray-600 text-sm mb-4">
                Dispara um erro JavaScript assíncrono que será capturado 
                pelo handler global de erros.
              </p>
              <Button 
            ...
            <Card className="p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-3 font-semibold text-gray-900">Promise Rejeitada</h3>
              </div>
              <p className="text-gray-600 text-sm mb-4">
                Cria uma Promise rejeitada que será capturada pelo 
                handler de unhandled promise rejections.
              </p>
              <Button 
            ...
            <Card className="p-6">
              <div className="flex items-center mb-4">
                ...
                <h3 className="ml-3 font-semibold text-gray-900">Erro de Rede</h3>
              </div>
              <p className="text-gray-600 text-sm mb-4">
                Simula uma falha de conexão com servidor inexistente 
                para testar tratamento de erros de rede.
              </p>
              <Button 
          ...
          <Card className="p-6 mt-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm mb-4">
                Este componente irá disparar um erro quando o contador for maior que 3.
              </p>
