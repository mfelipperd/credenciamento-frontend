...
export const useRevenues = (filters: RevenueFilters) => {
  ...
  return useQuery({
    queryKey: queryKeys.finance.revenuesList(filters),
    queryFn: async () => {
...
export const useRevenueDetail = (id: string, fairId: string) => {
  ...
  return useQuery({
    queryKey: queryKeys.finance.revenueDetail(id),
    queryFn: async () => {
...
export const useFinanceKpis = (fairId: string, from?: string, to?: string) => {
  ...
  return useQuery({
    queryKey: queryKeys.finance.kpisByFair(fairId, from, to),
    queryFn: async () => {
      const params = new URLSearchParams();
...
export const useTopEmpresas = (fairId: string, from?: string, to?: string) => {
  ...
  return useQuery({
    queryKey: queryKeys.finance.topEmpresasByFair(fairId, from, to),
    queryFn: async () => {
      const params = new URLSearchParams();
      if (from) params.append("from", from);
      if (to) params.append("to", to);
...
export const useEntryModels = (fairId?: string, type?: EntryModelType) => {
  ...
  return useQuery({
    queryKey: queryKeys.finance.entryModelsByFair(fairId, type),
    queryFn: async () => {
      const params = new URLSearchParams();
...
export const useEntryModel = (id: string) => {
  ...
  return useQuery({
    queryKey: queryKeys.finance.entryModel(id),
    queryFn: async () => {
...
export const useClients = (q?: string) => {
  ...
  return useQuery({
    queryKey: queryKeys.finance.clientsByQuery(q),
    queryFn: async () => {
      const params = new URLSearchParams();
...
export const useClient = (id: string) => {
  ...
  return useQuery({
    queryKey: queryKeys.finance.client(id),
    queryFn: async () => {
...
export const useCreateRevenue = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: queryKeys.finance.revenues() });
      queryClient.invalidateQueries({ queryKey: queryKeys.finance.kpis() });
      queryClient.invalidateQueries({ queryKey: queryKeys.finance.topEmpresas() });
...
export const useCreateEntryModel = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: queryKeys.finance.entryModels() });
...
export const useCreateClient = () => {
  ...
  return useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: queryKeys.finance.clients() });
